...
5. **Cinematic Mode** for a distraction-free, full-screen agent wall over
   credited museum artworks with restrained local atmosphere.
...
Appearance settings provide a searchable gallery of 62 bundled 2560 × 1440
...
Utagawa Hiroshige, Vincent van Gogh, Georges Seurat, James McNeill Whistler,
George Inness, and many others. Gallery cards use lazy
320 × 180 thumbnails, expose artist and license details, and never decode the
master artwork until it is selected.

Every work is Public Domain and distributed through The Met Open
