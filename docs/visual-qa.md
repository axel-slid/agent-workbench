...
| Cinematic Mode | idle and four active panes; true full screen; searchable 62-work gallery and scene changes; borderless panes; multi-line terminal viewport; readable light-theme content; shared resizing; named-agent-only typed-`@` picker; Spotify at top-left; subtle playback-synchronized perimeter glow with an untouched center/player; aligned command dock; Results and exit controls |
...
- all 62 Cinematic scenes, 1440p master WebPs, and lazy 320 × 180 thumbnails resolve;
...
Release screenshots live in [`docs/screenshots`](screenshots/). The 62
